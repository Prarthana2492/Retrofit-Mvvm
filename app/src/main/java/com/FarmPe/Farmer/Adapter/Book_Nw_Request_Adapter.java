...
public class Book_Nw_Request_Adapter extends RecyclerView.Adapter<Book_Nw_Request_Adapter.MyViewHolder>  {
    ...
    public Book_Nw_Request_Adapter(Activity activity,List< Request_Class_HomePage_Bean> moviesList) {
