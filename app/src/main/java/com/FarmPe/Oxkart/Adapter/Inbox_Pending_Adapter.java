...
public class  Inbox_Pending_Adapter extends RecyclerView.Adapter<Inbox_Pending_Adapter.MyViewHolder>  {
    private List<Get_RFQ_List_Bean> productList;
    Activity activity;
    ...
    public Inbox_Pending_Adapter(Activity activity, List<Get_RFQ_List_Bean> moviesList) {
...
//            preview_model=view.findViewById(R.id.preview_model);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        final Get_RFQ_List_Bean products = productList.get(position);
        ...
        try {
            ...
            holder.looking_fr_details.setText(products.getBrandname());
            holder.item_model_name.setText(products.getModelname() );
