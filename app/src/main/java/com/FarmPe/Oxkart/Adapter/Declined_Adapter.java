...
public class Declined_Adapter extends RecyclerView.Adapter<Declined_Adapter.MyViewHolder>  {
    ...
    public Declined_Adapter(Activity activity, List< Request_Class_Home_Page_Bean> moviesList) {
